...
\newglossaryentry{pruning}
{
	name 		= Pruning,
	text 		= pruning,
	description = {Removal of unnecessarily branches in a tree}
}
...
\newglossaryentry{radar}
{
	...
	text 		= radar,
	plural 		= radars,
	description = {Acronym for Radio Detection And Ranging. A device that used radio waves to measure distance and bearing to other objects}
}
...
\newglossaryentry{no-measurement hypothesis}
{
	...
	description = {A self created measurement at the estimated position (with score 0)}
}
...
\newglossaryentry{track hypothesis}
{
	...
	description = {a new measurement which is inside the gate for an existing track}
}
...
\newglossaryentry{clutter}
{
	name 		= Clutter,
	text 		= clutter,
	description = {Noise in the form of false measurements which is assumed Poison distributed}
}
